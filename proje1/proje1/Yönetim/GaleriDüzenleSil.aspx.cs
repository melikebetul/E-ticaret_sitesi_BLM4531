...
namespace proje1.Yönetim
{
    public partial class GaleriEkleSil : System.Web.UI.Page
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select * from tblGaleri", conn);
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmd = new SqlCommand("delete FROM tblGaleri where id='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            gvbind();
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("update tblGaleri set Baslik='" + textAd.Text + "',KategoriId='" + Convert.ToInt32(textFiyat.Text)  + "',Resim='" + textResim.Text  + "'", conn);
            cmd.ExecuteNonQuery();
            conn.Close();
            gvbind();
            //GridView1.DataBind();  
